    ...
    <nav className="text-white p-4 bg-[#0101272d] px-6">
      <div className="container mx-auto flex justify-between items-center">
        ...
        <ul className="flex space-x-4 ml-16">
          <li><a href="/" className="hover:text-zinc-400">Home</a></li>
          <li><a href="/dashboard" className="hover:text-zinc-400">Dashboard</a></li>
          <li><a href="/resume" className="hover:text-zinc-400">Resume Ranking</a></li>
          <li><a href="/git" className="hover:text-zinc-400">Git Tracking</a></li>
        </ul>
        <div className="flex space-x-4 items-center">
          ...
          {isAuthenticated ? (
            ...
            <button onClick={() => router.push('/auth/login')} className="bg-blue-500 text-white px-4 py-2 rounded-lg">Login</button>
          )}
        </div>
      </div>
    </nav>
